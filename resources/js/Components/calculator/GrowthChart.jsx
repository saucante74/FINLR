...
import { formatCompact, formatCurrency } from '@/lib/compound';
...
export default function GrowthChart({ result }) {
    ...
    const xScale = (year) => (year / maxYear) * innerWidth;
    const yScale = (value) => innerHeight - (Math.max(value, 0) / niceMax) * innerHeight;
