...
class ShowAnalogySimulatorTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_a_free_plan_user_receives_a_403(): void
    {
        ...
        $response = $this->actingAs($user)->get('/simulators/analogy');
    ...
    public function test_a_pro_plan_user_receives_200_with_the_expected_inertia_component(): void
    {
        ...
        $response->assertOk();
        $response->assertInertia(fn (Assert $page) => $page->component('simulator/AnalogySimulator'));
    }
    ...
    public function test_it_passes_the_six_default_values_as_the_defaults_prop(): void
    {
        ...
        $response->assertInertia(fn (Assert $page) => $page
            ->component('simulator/AnalogySimulator')
    ...
    {
        $response = $this->get('/simulators/analogy');
