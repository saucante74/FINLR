...
namespace Tests\Feature\PublicCalculator;

use Inertia\Testing\AssertableInertia as Assert;
use Tests\TestCase;

class PublicCalculatorPageTest extends TestCase
{
    public function test_home_page_is_accessible_and_renders_the_calculator_component(): void
    {
        ...
        $response->assertInertia(fn (Assert $page) => $page->component('PublicCalculator'));
    }
